...
//                 <div className="grow">
//                     <p>
//                         <a className="font-semibold cursor-pointer hover:underline">Vishy </a>shared an<a className="text-socialBlue"> album</a></p>
...
//             </div>
//             <div>
//                 <p className="my-3 text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempora perspiciatis pariatur autem, cumque voluptatem ullam qui modi ea odio eum fuga dicta, est atque, vero magnam maxime sequi! Commodi, non!</p>
//                 <div className="rounded-md overflow-hidden">
//                     <img src = "https://pbs.twimg.com/media/F0qLWjnX0AARpxG?format=jpg&name=medium"></img>
//                 </div>
//             </div>
...
//                     <textarea className=" block w-full h-full p-1 px-4 overflow-hidden rounded-full h-12" placeholder = {"Leave a comment!"}></textarea>
  ...
  return (
    <Card>
      ...
      <div>
        ...
        <div className="rounded-md overflow-hidden">
          <img src="https://pbs.twimg.com/media/F0qLWjnX0AARpxG?format=jpg&name=medium" alt=""/>
        </div>
      </div>
      <div className="mt-5 flex gap-8">
        <button className="flex gap-2 items-center">

        ...
        <div className="relative overflow-hidden rounded-md">
          ...
          <div className="p-4 pt-0 md:pt-4 pb-0">
            <div className="ml-24 md:ml-40">
              ...
              <div className="text-gray-500 leading-4">Chennai, India</div>
            </div>
          ...
          <Card>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-md overflow-hidden h-48 flex items-center shadow-md">
                <img src="https://pbs.twimg.com/media/DSVtMtdV4AE4mvE?format=jpg&name=small" alt=""/>
              </div>
              <div className="rounded-md overflow-hidden h-48 flex items-center shadow-md">
                <img src="https://pbs.twimg.com/media/EjJDazZWsAAgFTI?format=jpg&name=small" alt=""/>
              </div>
              <div className="rounded-md overflow-hidden h-48 flex items-center shadow-md">
                <img src="https://pbs.twimg.com/card_img/1799748543575695360/ZZydcRvO?format=jpg&name=small" alt=""/>
              </div>
              <div className="rounded-md overflow-hidden h-48 flex items-center shadow-md">
                <img src="https://pbs.twimg.com/media/FhXkv-vacAAe-Bw?format=jpg&name=small" alt=""/>
              </div>
            </div>
          </Card>
        </div>
